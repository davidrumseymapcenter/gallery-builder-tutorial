...
<img src="images/papillon.png" alt="Image of a baby with butterfly wings in an old-fashioned high chair" width="600">
...
<img src="images/mitchellmaps.png" alt="Screenshot of a gallery of multiple copies of the same map in a broswer window with an enlargement of one in a pane on the right side of the window." width="400"> 
...
<img src="images/amwestbib.png" alt="Screenshot of a bibliographic list of maps in a Canvas LMS page." width="400"> <img src="images/amwestimg.png" alt="Screenshot of a gallery of map images in a broswer window with an enlargement of one in a pane on the right side of the window." width="400"> 

<hr>

### Creating abridged versions of longer texts

The tool can be used to create galleries that show all of the pages in a book that contain images. 
