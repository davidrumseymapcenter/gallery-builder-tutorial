...
title: Open Manifest in Universal Viewer 
nav_order: 5
---

# Saving and Sharing

To open your gallery as a collection in a IIIF Viewer it must be hosted in the cloud.
...
- Can you find the titles of the items?

- What other information about the items do you see?

- Compare the metadata for the collection with the metadata for an object. 
