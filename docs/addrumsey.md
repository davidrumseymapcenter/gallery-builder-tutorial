...
- Look for the grey box that says IIIF Manifests. Click on the triangle at left in that box to reveal an additional field. Click the copy icon at right to copy the URL, or use control-click to copy.  
